...
const STATE_KEY = "bookmaker_state_v9";
...
function getChapterContext() {
  ...
  return {
    prev: state.chapters[idx - 1]?.content || "",
    next: state.chapters[idx + 1]?.content || ""
  };
}
...
async function runAI(mode) {
  ...
  const context = useContext ? getChapterContext() : {};
